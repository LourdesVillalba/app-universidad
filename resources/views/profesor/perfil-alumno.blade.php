...
<div class="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
    <div class="bg-gradient-to-r from-blue-600 to-teal-600 px-6 py-8 text-white">
        <div class="flex items-center space-x-6">
            ...
            <div>
                ...
                <p class="text-sm text-blue-100 mt-1">DNI: {{ $perfil->dni }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="px-6 py-6 grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50">
        ...
        <div>
            ...
            <p><strong>LinkedIn:</strong>
                @if($perfil->linkedin)
                    <a href="{{ $perfil->linkedin }}" class="text-blue-600 hover:underline" target="_blank">
                        Ver perfil
                    </a>
                @else
                    No cargado
            ...
            <p><strong>GitHub:</strong>
                @if($perfil->github)
                    <a href="https://github.com/{{ $perfil->github }}" class="text-blue-600 hover:underline" target="_blank">
                        Ver perfil
                    </a>
                @else
                    No cargado
    ...
    <div class="px-6 py-6">
        <h4 class="text-lg font-semibold mb-2">Descripción personal</h4>
